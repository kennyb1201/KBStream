...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "TMDB_API_KEY", tmdbApiKey.quoted())
        buildConfigField("String", "SIMKL_CLIENT_ID", simklClientId.quoted())
        buildConfigField("String", "SIMKL_CLIENT_SECRET", simklClientSecret.quoted())
    }
