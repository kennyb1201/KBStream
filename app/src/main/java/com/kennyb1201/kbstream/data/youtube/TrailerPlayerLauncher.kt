...
object TrailerPlayerLauncher {
    ...
    /**
     * Resolves a YouTube URL/ID down to a directly-playable
     * stream URL without launching any UI.
     *
     * NewPipe is attempted first.
     * NewPipeManager automatically falls back to Piped if
     * NewPipe cannot provide a usable muxed stream.
     *
     * Used by both the inline hero trailer player and
