...
data class SimklMovie(
    @Json(name = "title") val title: String?,
    @Json(name = "year") val year: Int?,
    @Json(name = "ids") val ids: SimklMovieIds?,
    @Json(name = "poster") val poster: String?
)

@JsonClass(generateAdapter = true)
data class SimklAnime(
    @Json(name = "title") val title: String?,
    @Json(name = "year") val year: Int?,
    @Json(name = "ids") val ids: SimklAnimeIds?,
    @Json(name = "poster") val poster: String?
)
...
@JsonClass(generateAdapter = true)
data class SimklMovieSyncItem(
    @Json(name = "status") val status: String?,
    @Json(name = "last_watched_at") val lastWatchedAt: String?,
    @Json(name = "movie") val movie: SimklMovie?
)

@JsonClass(generateAdapter = true)
data class SimklAnimeSyncItem(
    @Json(name = "status") val status: String?,
    @Json(name = "last_watched_at") val lastWatchedAt: String?,
    @Json(name = "next_to_watch_info") val nextToWatchInfo: SimklNextToWatchInfo?,
    @Json(name = "show") val show: SimklAnime?
)

data class SimklLibraryItem(
    val title: String,
    val year: Int?,
