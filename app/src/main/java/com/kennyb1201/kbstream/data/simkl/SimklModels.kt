...
data class SimklContinueWatchingItem(
    val id: String,
    // IMDb id (e.g. "tt1234567") pulled from Simkl's ids block, used for navigation/
    // detail lookup against Stremio addons — which key on IMDb ids, not Simkl's own
    // internal numeric id. Null if Simkl didn't return one for this title.
    val imdbId: String?,
    val title: String,
    val year: Int?,
