...
interface IptvDao {
    ...
    /**
     * Call this before a streamed XMLTV import. The importer then inserts bounded
     * batches, so it never needs to retain an entire guide in memory.
     */
    @Transaction
    ...
    /**
     * Kept for callers that already have complete lists. Do not use this path for
     * large XMLTV imports because those lists can consume substantial memory.
     */
    @Transaction
