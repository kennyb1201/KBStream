    ...
    suspend fun getContinueWatching(
        ...
        val watchingMapped = watchingShows
            ...
            .mapNotNull { item ->
                ...
                // Parse exact next target from nextToWatch or lastWatched safely without forcing 1x1 fallbacks
                ...
                SimklContinueWatchingItem(
                    ...
                    progress = null, // <--- EXPLICITLY NULL: Prevents unwanted progress bars on standard watchlist items
                    ...
                    mediaType = "series",
                    source = "watching",
                    season = nextSeason,   // <--- Clean target parsed directly or left null if unknown
                    episode = nextEpisode  // <--- Clean target parsed directly or left null if unknown
                )
            }
            .toList()
