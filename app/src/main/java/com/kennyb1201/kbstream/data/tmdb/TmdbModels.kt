...
// Local-only match wrapper used by SearchViewModel's client-side genre filter.
// mediaType is "movie" or "series" to match DetailScreen's onNavigateTag(type) param.
