...
// A single episode's air info, as returned inline on a TV show's detail response
// (both "next_episode_to_air" and "last_episode_to_air" use this same shape).
@JsonClass(generateAdapter = true)
...
data class TmdbDetail(
    ...
    // TV-only fields (null for movies). Used to tell whether a show actually
    // released something recently, vs. Simkl just saying you have an unwatched
    // episode queued up somewhere in a backlog.
