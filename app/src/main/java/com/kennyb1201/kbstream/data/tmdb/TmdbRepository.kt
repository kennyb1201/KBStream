...
class TmdbRepository(context: Context) {
    ...
    // Room dao for persisted imdb resolution cache
    ...
    private val imdbResolutionTtlMs = 30L * 24L * 60L * 60L * 1000L // 30 days
    ...
    // Persistent, cache-first resolveImdbId
    suspend fun resolveImdbId(tmdbId: Int, type: String): String? {
        ...
        if (!imdbId.isNullOrBlank()) {
            ...
            runCatching {
                ...
                imdbResolutionDao.deleteOlderThan(now - MAX_IMDB_DISK_AGE_MS)
            }
        }
