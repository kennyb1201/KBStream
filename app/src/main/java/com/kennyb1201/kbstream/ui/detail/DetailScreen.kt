                            ...
                            item(key = "episodes_row") {
                                LazyRow(
                                    ...
                                    items(
                                        ...
                                        val isCompleted = completedEpisodeIds.contains(ep.streamId)

                                        EpisodeCard(
                                            ep = ep,
                                            isCompleted = isCompleted,
                                            isResumeTarget = hasResumeHere,
                                            onClick = {
    ...
    KBCard(
        ...
        Column {
            ...
            Column(modifier = Modifier.padding(10.dp)) {
                ...
                Text(
                    text = if (runtimeText.isNotBlank()) {
                        "E${ep.episodeNumber} · $runtimeText"
                    } else {
                        "E${ep.episodeNumber}"
                    },
                    style = MaterialTheme.typography.titleMedium,
                    color = if (isCompleted) KBAccent else KBTextHi
                )
