                    ...
                    Column(modifier = Modifier.padding(start = 24.dp, end = 24.dp, bottom = 8.dp)) {
                        val metaLine = remember(m, tmdbDetail, type) {
                            val yearInfo = if (type == "series") {
                                formatSeriesYearRange(tmdbDetail) ?: tmdbDetail?.releaseYear() ?: m.releaseInfo
                            } else {
                            ...
                            listOfNotNull(
                                ...
                                yearInfo,
                                if (type == "series") seriesStatusTag(tmdbDetail) else null,
                                m.runtime,
...
private fun formatSeriesYearRange(detail: com.kennyb1201.kbstream.data.tmdb.TmdbDetails?): String? {
...
private fun seriesStatusTag(detail: com.kennyb1201.kbstream.data.tmdb.TmdbDetails?): String? {
    val status = detail?.status?.trim().orEmpty()
    return when {
