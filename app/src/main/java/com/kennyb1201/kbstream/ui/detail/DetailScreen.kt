...
fun DetailScreen(
    ...
    val hasSeriesResume = type == "series" &&
    ...
    val targetEpisodeNumber = remember(type, hasSeriesResume, effectiveSeason, resumeSeason, resumeEpisode, resolvedTargetEpisode) {
        if (type != "series") {
            null
        } else if (hasSeriesResume && effectiveSeason == resumeSeason) {
                                ...
                                item(key = "episodes_row") {
                                    LazyRow(
                                        ...
                                        items(
                                            ...
                                            LaunchedEffect(shouldFocusThisCard, episodesLoading, effectiveSeason) {
