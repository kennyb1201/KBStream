    ...
    KBCard(
        ...
        Column(modifier = Modifier.width(120.dp)) {
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .height(180.dp) // 2:3, matches TMDB's actual profile image ratio
                ...
                if (posterUrl != null) {
                    ...
                    // No profile photo on TMDB -- show initials instead of a blank box
...
private fun PeopleSeparatorCard() {
    Box(modifier = Modifier.width(32.dp).height(180.dp).padding(end = 12.dp), contentAlignment = Alignment.Center) {
