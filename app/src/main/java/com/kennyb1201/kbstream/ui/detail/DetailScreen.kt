                    ...
                    LazyColumn(
                        ...
                        item(key = "info_block") {
                            Column(
                                ...
                                m.country?.let {
                                    Text(text = "Country: $it", color = KBTextLo, modifier = Modifier.padding(top = 4.dp))
                                }
                                m.language?.let {
                                    Text(text = "Language: $it", color = KBTextLo, modifier = Modifier.padding(top = 4.dp))
                                }
                                m.awards?.let {
                                    Text(text = "Awards: $it", color = KBTextLo, modifier = Modifier.padding(top = 4.dp))
                                }
                            }
                        }
...
private fun CastCard(member: TmdbCastMember, onClick: () -> Unit) {
    KBCard(
        ...
        Column {
            ...
            Text(text = member.name, modifier = Modifier.padding(6.dp))
            member.character?.let {
                Text(text = it, color = KBTextLo, modifier = Modifier.padding(horizontal = 6.dp))
            }
        }
    }
}
