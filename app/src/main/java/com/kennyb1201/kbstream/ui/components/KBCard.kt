...
/**
 * The one signature interaction in KBStream: when a card gets D-pad focus,
 * it scales up and picks up a brass glow + border -- a spotlight finding
 * whatever you're looking at, not a plain highlight box.
 */
@Composable
fun KBCard(
    onClick: () -> Unit,
